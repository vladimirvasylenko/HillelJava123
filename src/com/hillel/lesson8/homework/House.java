...
public class House {
    ...
    private Table table = new Table("IKEA", "white", 120);
    private Chair chair = new Chair("IKEA", "white", 40);
    private Cupboard cupboard = new Cupboard("IKEA", "grey", 150);
    private Sofa sofa = new Sofa("IKEA", "black", 130);
    private Bed bed = new Bed("Skandi Wood", "brown", 200);
